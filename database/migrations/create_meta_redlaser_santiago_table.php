...
class CreateMetaSantiagoRedlaserTable extends Migration
{
    public function up()
    {
        Schema::create('meta_santiago_redlaser', function (Blueprint $table) {
            $table->id();
            $table->date('fecha');
    ...
    {
        Schema::dropIfExists('meta_santiago_redlaser');
    }
}
