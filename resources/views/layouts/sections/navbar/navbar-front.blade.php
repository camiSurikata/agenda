    ...
    <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-3 px-md-4">
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link fw-medium text-nowrap"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 d-none d-lg-block">
                                <div class="bg-body nav-img-col p-2">
                                    <img src="{{ asset('assets/img/front-pages/misc/nav-item-col-img-' . $configData['style'] . '.png') }}"
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <!-- navbar button: Start -->
            <li>
                <a href="{{ url('/auth/login-cover') }}" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4"
