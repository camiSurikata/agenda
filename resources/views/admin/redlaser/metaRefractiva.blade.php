...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Redlaser /</span> Meta Campaña Refractiva
    </h4>
                        ...
                        <div class="card-info">
                            <div class="d-flex align-items-center">
                                <h4 style="color: black;" class="mb-0">$
                                    {{ number_format($porConversaciones, 0, ',', '.') }}</h4>
                        ...
                        <div class="card-info">
                            <div class="d-flex align-items-center">
                                <h4 class="mb-0" style="color:black;">
                                    {{ str_replace(',', '.', number_format($alcance, 0)) }}</h4>
                                {{-- <i class="mdi mdi-chevron-down text-danger mdi-24px"></i> --}}
                                {{-- <small class="text-danger">8.10%</small> --}}
                            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <div class="card-info">
                            <div class="d-flex align-items-center">
                                <h4 class="mb-0" style="color:black;">
                                    {{ str_replace(',', '.', number_format($impresiones, 0)) }}</h4>
                                {{-- <i class="mdi mdi-chevron-down text-danger mdi-24px"></i> --}}
                                {{-- <small class="text-danger">8.10%</small> --}}
                            </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div>
                    ...
                    <button type="button" id="ingresoRefractiva" class="btn btn-primary d-none" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
                        Ingresar Datos
                    </button>
                    @can('meta-create')
                        <a href="#" class="btn btn-success" data-toggle="modal" data-target="#ModalCreateSantiago"
                            style="color: white">
                        ...
                        <tbody>
                            @foreach ($cataratas as $catarata)
                                <tr>
                                    ...
                                    <td style="color: black; background: #efafaf7a">
                                        {{ number_format($catarata->alcance, 0, ',', '.') }}</td>
                                    <td style="color: black; background: rgba(81, 168, 255, 0.355)">
                                        {{ number_format($catarata->impresiones, 0, ',', '.') }}</td>
                                    <td style="color:black;background:#ecefaf7f">{{ $catarata->conversaciones }}</td>
                                    <td style="color: black; background: #d7afef77">$
                                        {{ number_format($catarata->porConversaciones, 0, ',', '.') }}</td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="dataForm" action="{{ route('storeRefractiva.data') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="impresiones" class="form-label">Impresiones</label>
                            <input type="number" class="form-control" id="impresiones" name="impresiones" required>
                        </div>
                        <div class="mb-3">
                            <label for="importeGastado" class="form-label">Importe Gastado</label>
                            <input type="number" class="form-control" id="importeGastado" name="importeGastado"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="conversaciones" class="form-label">Conversaciones</label>
                            <input type="number" class="form-control" id="conversaciones" name="conversaciones"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="porConversacion" class="form-label">Por Conversación</label>
                            <input type="number" class="form-control" id="porConversaciones" name="porConversaciones"
                                required>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        if (idUser === '5' || idUser === '13') {
            document.getElementById('ingresoRefractiva').classList.remove('d-none');
        }
    </script>
