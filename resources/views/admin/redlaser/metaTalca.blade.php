...
@section('content')
<h4 class="py-3 mb-4">
<span class="text-muted fw-light">Redlaser /</span> Meta Campaña Talca
</h4>
            ...
            <div class="card">
                ...
                <table class="datatables-ajax table table-bordered">
                    ...
                    <tr>
                        ...
                        <th style="color:black;background:#ecefafda">Conversaciones iniciadas</th>
                        <th style="color:black;background:#d7afefda"> Valor conversacion iniciada</th>
