...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('paciente.store') }}" method="POST" class="card p-4 shadow-sm">
            @csrf
            <div class="mb-3">
                ...
                <select id="prevision" name="prevision" class="form-select" required>
                    ...
                    @foreach($convenios as $convenio)
                        <option value="{{ $convenio->id }}" 
                            {{ old('prevision') == $convenio->id ? 'selected' : '' }}>
                            {{ $convenio->convenio }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" required oninput="validarFechaNacimiento(this)">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="rut" name="rut" value="{{ old('rut') }}" required oninput="validarRut(this)" placeholder="Ej: XX.XXX.XXX-X">
    ...
    <script>
        // Validaciones del formulario, mismas que las que tenías en el "edit"
