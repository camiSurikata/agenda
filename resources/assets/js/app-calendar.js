...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
      ...
      try {
        ...
        if (response.ok) {
          ...
          let events = data.map(cita => ({
            ...
            extendedProps: {
              calendar: 'Confirmado' // O personaliza este valor si es necesario
            }
          }));
    ...
    document.addEventListener('DOMContentLoaded', function () {
      const inlineCalInstance = new FullCalendar.Calendar(document.getElementById('inline-calendar'), {
        // configuración aquí
      });
